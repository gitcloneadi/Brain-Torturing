...
arr[]
 and an integer 
target
, determine if there exists a triplet in the array whose sum equals the given 
target
.
...
Return 
true
 if such a triplet exists, otherwise, return 
false
.
...
Company Tags :Accolite Amazon Microsoft OYO Rooms Samsung CarWale
Topic Tags :two-pointer-algorithm Arrays Hash Sorting
