...
Inversion Count of the array. I
nversion count is the number of pairs of elements (i, j) such that i < j and arr[i] > arr[j].
...
Topic Tags :Arrays Divide and Conquer Sorting
