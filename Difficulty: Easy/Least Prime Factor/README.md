...
 and need to use 
1-based indexing
 to store the answer for each number.
...
leastPrimeFactor() 
which takes N as input parameter and returns a list of integers containing all the least prime factors of each number from 1 to N.
...
Topic Tags :Mathematical Prime Number sieve
